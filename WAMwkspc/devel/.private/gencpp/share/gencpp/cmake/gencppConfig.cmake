...
if("TRUE" STREQUAL "TRUE")
  set(gencpp_SOURCE_PREFIX /home/dhruv/RobotArm/WAMwkspc/src/gencpp)
  set(gencpp_DEVEL_PREFIX /home/dhruv/RobotArm/WAMwkspc/devel/.private/gencpp)
  set(gencpp_INSTALL_PREFIX "")
  set(gencpp_PREFIX ${gencpp_DEVEL_PREFIX})
else()
  set(gencpp_SOURCE_PREFIX "")
  set(gencpp_DEVEL_PREFIX "")
  set(gencpp_INSTALL_PREFIX /home/dhruv/RobotArm/WAMwkspc/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gencpp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dhruv/RobotArm/WAMwkspc/src/gencpp/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dhruv/RobotArm/WAMwkspc/devel/.private/gencpp/lib;/home/dhruv/RobotArm/WAMwkspc/devel/lib;/opt/ros/kinetic/lib)
