...
if("TRUE" STREQUAL "TRUE")
  set(message_runtime_SOURCE_PREFIX /home/dhruv/RobotArm/WAMwkspc/src/message_runtime)
  set(message_runtime_DEVEL_PREFIX /home/dhruv/RobotArm/WAMwkspc/devel/.private/message_runtime)
  ...
  set(message_runtime_INSTALL_PREFIX /home/dhruv/RobotArm/WAMwkspc/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'message_runtime' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dhruv/RobotArm/WAMwkspc/src/message_runtime/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dhruv/RobotArm/WAMwkspc/devel/.private/message_runtime/lib;/home/dhruv/RobotArm/WAMwkspc/devel/lib;/opt/ros/kinetic/lib)
