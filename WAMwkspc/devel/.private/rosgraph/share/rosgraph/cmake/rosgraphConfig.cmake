...
if("TRUE" STREQUAL "TRUE")
  set(rosgraph_SOURCE_PREFIX /home/dhruv/RobotArm/WAMwkspc/src/ros_comm/rosgraph)
  set(rosgraph_DEVEL_PREFIX /home/dhruv/RobotArm/WAMwkspc/devel/.private/rosgraph)
  set(rosgraph_INSTALL_PREFIX "")
  set(rosgraph_PREFIX ${rosgraph_DEVEL_PREFIX})
else()
  set(rosgraph_SOURCE_PREFIX "")
  set(rosgraph_DEVEL_PREFIX "")
  set(rosgraph_INSTALL_PREFIX /home/dhruv/RobotArm/WAMwkspc/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosgraph' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dhruv/RobotArm/WAMwkspc/src/ros_comm/rosgraph/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dhruv/RobotArm/WAMwkspc/devel/.private/rosgraph/lib;/home/dhruv/RobotArm/WAMwkspc/devel/lib;/opt/ros/kinetic/lib)
