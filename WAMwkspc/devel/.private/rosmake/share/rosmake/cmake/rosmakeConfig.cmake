...
if("TRUE" STREQUAL "TRUE")
  set(rosmake_SOURCE_PREFIX /home/dhruv/RobotArm/WAMwkspc/src/ros/rosmake)
  set(rosmake_DEVEL_PREFIX /home/dhruv/RobotArm/WAMwkspc/devel/.private/rosmake)
  set(rosmake_INSTALL_PREFIX "")
  set(rosmake_PREFIX ${rosmake_DEVEL_PREFIX})
else()
  set(rosmake_SOURCE_PREFIX "")
  set(rosmake_DEVEL_PREFIX "")
  set(rosmake_INSTALL_PREFIX /home/dhruv/RobotArm/WAMwkspc/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosmake' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dhruv/RobotArm/WAMwkspc/src/ros/rosmake/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dhruv/RobotArm/WAMwkspc/devel/.private/rosmake/lib;/home/dhruv/RobotArm/WAMwkspc/devel/lib;/opt/ros/kinetic/lib)
