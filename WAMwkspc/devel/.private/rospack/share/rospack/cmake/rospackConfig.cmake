...
if("TRUE" STREQUAL "TRUE")
  set(rospack_SOURCE_PREFIX /home/dhruv/RobotArm/WAMwkspc/src/rospack)
  set(rospack_DEVEL_PREFIX /home/dhruv/RobotArm/WAMwkspc/devel/.private/rospack)
  set(rospack_INSTALL_PREFIX "")
  set(rospack_PREFIX ${rospack_DEVEL_PREFIX})
else()
  set(rospack_SOURCE_PREFIX "")
  set(rospack_DEVEL_PREFIX "")
  set(rospack_INSTALL_PREFIX /home/dhruv/RobotArm/WAMwkspc/install)
...
if(NOT "/home/dhruv/RobotArm/WAMwkspc/src/rospack/include;/usr/include " STREQUAL " ")
  set(rospack_INCLUDE_DIRS "")
  set(_include_dirs "/home/dhruv/RobotArm/WAMwkspc/src/rospack/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rospack' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dhruv/RobotArm/WAMwkspc/src/rospack/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rospack_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rospack;/home/dhruv/anaconda2/lib/libpython2.7.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;/usr/lib/x86_64-linux-gnu/libboost_program_options.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libtinyxml.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dhruv/RobotArm/WAMwkspc/devel/.private/rospack/lib;/home/dhruv/RobotArm/WAMwkspc/devel/lib;/opt/ros/kinetic/lib)
