...
"""autogenerated by genpy from wam_srvs/JointMoveBlockRequest.msg. Do not edit."""
import sys
...
class JointMoveBlockRequest(genpy.Message):
  ...
  _type = "wam_srvs/JointMoveBlockRequest"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_B().pack(self.blocking))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.blocking,) = _get_struct_B().unpack(str[start:end])
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from wam_srvs/JointMoveBlockResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class JointMoveBlockResponse(genpy.Message):
  ...
  _type = "wam_srvs/JointMoveBlockResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
"""
  __slots__ = []
