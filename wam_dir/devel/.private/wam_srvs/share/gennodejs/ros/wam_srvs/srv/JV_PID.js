...
class JV_PIDRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type JV_PIDRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type JV_PIDRequest
    let len;
    let data = new JV_PIDRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new JV_PIDRequest(null);
    if (msg.kp !== undefined) {
      resolved.kp = msg.kp;
    }
    else {
...
class JV_PIDResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type JV_PIDResponse
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type JV_PIDResponse
    let len;
    let data = new JV_PIDResponse(null);
    return data;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'wam_srvs/JV_PIDResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JV_PIDResponse(null);
    return resolved;
    }
};

module.exports = {
  Request: JV_PIDRequest,
  Response: JV_PIDResponse,
  md5sum() { return '0db10bb243a6ebb8fbb8a7f8aee28be0'; },
  datatype() { return 'wam_srvs/JV_PID'; }
};
